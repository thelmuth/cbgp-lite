...
qstat_suffix = "-CBGP-PSB-Backtrack"

# Directory to hold results for each problem. Change for each set of runs
basedir = "/usr/local/research/compsci/helmuth/jfedoroff/cbgp-function-backtracking/original-with-backtracking-psb2/"
...
cmd_line_params = """ --backtracking true """
